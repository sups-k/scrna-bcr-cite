...
# Iterate function across desired clusters - in this case, 22 clusters at 0.8 resolution
Idents(object = seurat_integrated) <- "integrated_snn_res.0.8"
conserved_markers <- map_dfr(0:27, get_conserved)
...
write.csv(conserved_markers, file = "results/top10_markers_per_cluster_res0.8.csv", row.names = FALSE)
