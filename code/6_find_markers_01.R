...
# Iterate function across desired clusters - in this case, 22 clusters at 0.1 resolution
...
write.csv(conserved_markers, file = "results/top10_markers_per_cluster_res0.1.csv", row.names = FALSE)
