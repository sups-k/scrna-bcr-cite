...
seurat_integrated <- readRDS(file = "results/output_rds/seurat_integrated.rds")
...
seurat_integrated <- FindClusters(object = seurat_integrated,
                                  resolution = seq(from = 0.05, to = 1.0, by = 0.05))
...
# Save the new object
saveRDS(seurat_integrated, "results/output_rds/pc10_seurat_integrated.rds")
